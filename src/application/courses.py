...
class CourseServices:
  ...
  def get_all(self, formated: bool = False) -> list[schemas.CourseOut]:
  ...
  def get_one(self, id: int, formated: bool = False) -> schemas.CourseOut:
  ...
  def update_one(self, id: int):
    response = self.repo.update_course_by_id(id)
    return response
